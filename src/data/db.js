...
const store = {
  ...
  boardGames: [
    ...
    { id: uuid(), title: 'Wsiąść do Pociągu', description: 'Buduj trasy kolejowe.', people: 5, hours: 1, accessibility: true, owner: 'Demo User' },
    { id: uuid(), title: 'Dominion', description: 'Gra karciana z talią.', people: 4, hours: 1, accessibility: true, owner: 'Demo User' },
  ],
  tournaments: [],
  events: [],
  players: [],
